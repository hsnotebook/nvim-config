...
vim.cmd([[
  let ctfo = { 'name': 'ctfo', 'path': '~/wiki/jobs/ctfo', 'auto_toc': 1, 'syntax': 'markdown', 'ext': 'md' }
  ...
  let job = { 'name': 'job', 'path': '~/wiki/jobs/archive', 'auto_toc': 1, 'syntax': 'markdown', 'ext': 'md' }
  let g:vimwiki_list = [ctfo, IT, finance, personal, job]
